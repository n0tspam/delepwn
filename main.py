...
def main():
    ...
    parser_enum.add_argument('--output', action='store_true', default=False, help='Enable colored, formatted output in results.txt file') 
    ...
    enum_output = args.output
    if args.command == 'enum':
        check_gcp_bearer_access_token(args.email, verbose, enum_output)
